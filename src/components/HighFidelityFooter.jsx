    ...
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div
          ...
          style={{
            backgroundImage:
              "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.3'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")",
          }}
        ></div>
      </div>
        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Professional laundry services with free pickup and delivery. We're
              committed to providing exceptional care for your garments while
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Get exclusive laundry tips, seasonal offers, and updates delivered
              to your inbox.
            </p>
            ...
            {[
              {
                ...
                onClick: () => {
                  window.open(
                    "https://maps.google.com?q=123+Main+Street,+Your+City,+ST+12345",
                    "_blank"
                  );
                },
              },
